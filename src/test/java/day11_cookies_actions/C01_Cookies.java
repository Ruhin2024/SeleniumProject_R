...
public class C01_Cookies extends TestBase {
    ...
    /*
    Cookieler ile ilgili tüm islemleri manage() methodu sayesinde yapabiliriz
     */
    ...
    public void test01() {
        ...
        driver.navigate().refresh();
        waitForSecond(3);
        //bu codelari tamamen captcha yi manual olarak asabilmek icin yazdik
        ...
        driver.manage().deleteAllCookies();//sayfamizdaki tüm cookieleri sildik
        cookieSet = driver.manage().getCookies();
